  ...
  public class Libro : MaterialDigital, IPrestable
{
    ...
    {
        Validacion.CadenaMin(idioma, 4, "El idioma debe tener al menos 4 caracteres.");
        Validacion.EnteroMin(cantPaginas, 1, "La cantidad de páginas debe ser mayor a 0.");
    ...
    {
        Validacion.ValidarISBN(Id, "El ISBN del libro es inválido.");
