...
namespace Biblioteca.Models;
    ...
    public class Libro : MaterialDigital, IPrestable
    {
            ...
            : base(id, titulo, autor, fechaPublicacion)
        {
            ...
            if (editorial == null)
                throw new ArgumentException("El libro debe tener una editorial asociada.");
        ...
        {
            Console.WriteLine(
                $"Libro: {Titulo} | Autor: {Autor} | Género: {Genero} | Páginas: {CantPaginas} | Idioma: {Idioma} | Editorial: {Editorial.Nombre}");
        }
        ...
        public override void ValidarIntegridad()
        {
            ...
            if (CantPaginas <= 0)
                throw new ArgumentException("La cantidad de páginas debe ser mayor a 0.");
            if (Editorial == null)
                throw new ArgumentException("El libro debe tener una editorial asociada.");
        }
